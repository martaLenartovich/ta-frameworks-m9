...
var logger = require("../config/logger.config.js");
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        _b.sent();
                        logger.info('2. Select "All Cities in Belarus" option in Location dropdown');
                    ...
                    case 6:
                        _b.sent();
                        logger.info('3. Select "Software Test Engineering" skill in Skills dropdown');
